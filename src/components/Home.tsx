      ...
      <div className="flex flex-col md:flex-row gap-4 items-center justify-between shrink-0">
        <form onSubmit={handleSearch} className="relative w-full md:max-w-md">
          ...
          <input 
            ...
            className="w-full pl-11 pr-4 py-3 rounded-2xl bg-white dark:bg-slate-800 border-2 border-slate-100 dark:border-slate-700 focus:border-blue-500 focus:ring-0 outline-none text-slate-700 dark:text-slate-200 transition-colors shadow-sm no-spinners"
          />
        </form>
