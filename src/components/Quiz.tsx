...
import { CheckCircle2, XCircle, BrainCircuit, AlertCircle, Loader2, Settings, ArrowLeft, ArrowRight, Flag, Menu, X, Clock, Search, BookOpen } from 'lucide-react';
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/50 backdrop-blur-sm">
          ...
          >
            ...
            <div className="flex gap-4">
              ...
              <button 
                onClick={() => { setShowLeavePrompt(false); clearSession(); }}
